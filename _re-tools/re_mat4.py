# -*- coding: utf-8 -*-
# ES: Desensambla el encolador de ataque modo 4 (0x6744A0, con 2 comprobaciones isAlly + push), 0x791B40
#     (opera sobre *(AI+0x20)) y pushOrder (0x674300). Uso: python re_mat4.py
# EN: Disassembles the mode-4 attack enqueuer (0x6744A0, with 2 isAlly checks + push), 0x791B40
#     (operates on *(AI+0x20)) and pushOrder (0x674300). Usage: python re_mat4.py
...
dis(0x6744A0, 0x180, "encolador de ataque modo 4  0x6744A0 (2 gates isAlly + push)")
dis(0x791B40, 0xC0, "0x791B40 (opera sobre *(AI+0x20))")
dis(0x674300, 0x120, "pushOrder 0x674300", stop_ret=True)
