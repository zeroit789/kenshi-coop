# -*- coding: utf-8 -*-
# ES: Desensambla CombatClass::tick (vt+0x20 = 0x60D470) sin parar en ret, marcando accesos a +0x68/+0x70.
#     Uso: python re_mat11.py
# EN: Disassembles CombatClass::tick (vt+0x20 = 0x60D470) without stopping at ret, flagging +0x68/+0x70
#     accesses. Usage: python re_mat11.py
...
# CombatClass tick (vt+0x20 = 0x60D470) - watch +0x68/+0x70
dis(0x60D470, 0x300, "CombatClass::tick vt+0x20 0x60D470", watch=(0x68,0x70), stop_ret=False)
