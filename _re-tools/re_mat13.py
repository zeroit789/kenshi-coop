# -*- coding: utf-8 -*-
# ES: Desensambla Task_MeleeAttack::startAction (0x3341F0) y ::runAction (0x34CA40) marcando lecturas y
#     escrituras de +0xE8/+0x68/+0x70, para ver si escriben AnimationClass+0xE8 (currentAction).
#     Uso: python re_mat13.py
# EN: Disassembles Task_MeleeAttack::startAction (0x3341F0) and ::runAction (0x34CA40) flagging reads and
#     writes of +0xE8/+0x68/+0x70, to see whether they write AnimationClass+0xE8 (currentAction).
#     Usage: python re_mat13.py
...
# EN: Task_MeleeAttack startAction: does it write AnimationClass+0xE8 (currentAction)?
...
# EN: base Tasker runAction (vt+0x10) = purecall? and Task_MeleeAttack's one
