# -*- coding: utf-8 -*-
# ES: Desensambla getTasker (0x791B10) y AI::create (0x622110, sin parar en ret). Uso: python re_mat5.py
# EN: Disassembles getTasker (0x791B10) and AI::create (0x622110, without stopping at ret).
#     Usage: python re_mat5.py
...
dis(0x791B10, 0x40, "getTasker 0x791B10")
dis(0x622110, 0x300, "AI::create 0x622110", stop_ret=False)
