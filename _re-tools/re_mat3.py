# -*- coding: utf-8 -*-
# ES: Desensambla Character::attackTarget (0x5CB0A0), CombatClass::setAttackTarget (0x665580, escribe
#     +0x290) y CombatClass::go (0x60CC50). Uso: python re_mat3.py
# EN: Disassembles Character::attackTarget (0x5CB0A0), CombatClass::setAttackTarget (0x665580, writes
#     +0x290) and CombatClass::go (0x60CC50). Usage: python re_mat3.py
...
dis(0x5CB0A0, 0x120, "Character::attackTarget(who) 0x5CB0A0")
dis(0x665580, 0xB0, "CombatClass::setAttackTarget 0x665580 (escribe +0x290)")
dis(0x60CC50, 0x180, "CombatClass::go 0x60CC50")
